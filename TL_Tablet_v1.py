# -*- coding: utf-8 -*-
"""
Created on Thu Aug 12 09:51:43 2021
...
Xm, Xs = data['Xm_400'], data['Xs_400']
Xmtest,  Xstest  = data['Xtestm'], data['Xtests']
ytrain, ytest = data['ycal_400'], data['ytest']
...
#resnet_model = Model(inputs=base_model.input, outputs=base_model.get_layer('flatten_6').output)
...
base_model.layers[8].trainable == False
#base_model.layers[1].trainable == False
